...
const metricsData = [
  ...
  { title: "أدوات مكتبية", amount: "4000 دينار", icon: WalletIcon, iconColor: "text-success", bgColor: "bg-success/20" },
  { title: "منصرفات", amount: "1000 دينار", icon: TextIcon, iconColor: "text-alert", bgColor: "bg-alert/20" },
  { title: "رواتب", amount: "10,000 دينار", icon: TextIcon, iconColor: "text-[#5570F1]", bgColor: "bg-[#5570F1]/20" },
]

const ExpensesMetricCards = () => {
  return (
...
export default ExpensesMetricCards
