...
const DocumentDetailsFeature = () => {
    ...
    const documentDetails = [
        {
            label: "نوع المستند",
            value: document.document_type === "case" ? "تابع لقضية" : "غير تابع لقضية",
        },
        {
            label: "نوع المستند",
            value: document.document_category || "غير محدد",
        },
        {
            label: "اسم المستند",
    ...
    // إذا كان المستند تابع لقضية، أضف معلومات القضية
    if (document.document_type === "case" && document.caseId) {
        documentDetails.unshift({
            label: "رقم القضية",
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[#808080] mt-1 text-sm">
                                    {document.document_type === 'case' ? 'مستند متعلق بقضية' : 'مستند غير تابع لقضية'} 
                                </p>
                            </div>
                        </div>
