...
export const CLASSES = {
    ...
    uploadText: "text-[10px] md:text-sm text-gray-400 flex flex-col gap-1 md:gap-4",
    formSection: "border border-gray-300 p-3 md:p-4 rounded-xl mt-4 md:mt-8",
    sectionTitle: "text-sm md:text-base lg:text-lg",
    submitButton: "w-full flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 text-white font-cairo rounded-[12px] transition-all whitespace-nowrap w-[120px] md:w-[241px] h-[40px] md:h-[50px] justify-center relative overflow-hidden text-sm md:text-base",
    label: "block text-sm md:text-base text-right mb-2 font-medium text-gray-700",
    input: "w-full mt-2 md:mt-4 border rounded-md p-2 text-[14px] md:text-[16px] text-[#B5B5B5] bg-[#FBFBFB] resize-none text-right",
    addButton: "mt-4 px-4 py-2 bg-blue-500 text-white rounded-lg text-sm hover:bg-blue-600 transition-colors",
    serviceItem: "bg-[#FBFBFB] p-3 rounded-lg border border-gray-200 w-[308px] h-[50px] flex flex-wrap ",
    serviceName: "text-sm font-medium text-gray-700",
    serviceDelete: "text-red-500 hover:text-red-700 cursor-pointer text-sm",
    modalOverlay: "fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center z-50",
    ...
    teamCard: "bg-[#FBFBFB] p-4 rounded-lg border border-gray-200 w-full sm:w-[400px]",
...
const About = () => {
    ...
    const initialValues: FormValues = {
        ...
        notes: "تأسس مكتب الدولي للمحاماة والاستشارات القانونية في دولة الكويت بهدف تقديم خدمات قانونية متميزة على أعلى مستوى من الاحترافية والمهنية. يتميز مكتبنا بفريق من المحامين الكويتيين ذوي الخبرة الواسعة في مختلف المجالات القانونية، مما يجعلنا قادرين على تقديم حلول قانونية شاملة ومتكاملة لعملائنا.\n\nيلتزم المكتب بتطبيق أعلى معايير السرية والنزاهة والشفافية في جميع تعاملاته، مع التركيز على تحقيق أفضل النتائج لعملائنا من خلال الفهم العميق لاحتياجاتهم وتقديم الاستشارات القانونية المناسبة وفقًا للقوانين الكويتية في الوقت المناسب.",
        vision: "نسعى لأن نكون المكتب القانوني الأول والأكثر ثقة في دولة الكويت، من خلال تقديم خدمات قانونية متميزة تجمع بين الخبرة المهنية العالية والتقنيات الحديثة، مع الحفاظ على القيم الأخلاقية والمهنية التي تميزنا، والمساهمة في تطوير البيئة القانونية الكويتية.",
        message: "تقديم خدمات قانونية متكاملة وفعالة تلبي احتياجات عملائنا وتحمي مصالحهم في إطار القوانين الكويتية، من خلال الاعتماد على فريق من المحامين الكويتيين المؤهلين والمتخصصين في مختلف المجالات القانونية، واستخدام أحدث التقنيات والأساليب المبتكرة في العمل القانوني.",
        teamMembers: [
            {
                name: "أحمد محمد",
                role: "محامي استشاري",
        ...
        contactInfo: { // إضافة معلومات التواصل الافتراضية
