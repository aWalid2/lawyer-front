            ...
            <CaseStatusFormDialog
                trigger={
                    <button
                        ...
                        className="flex items-center justify-center gap-1 px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 text-white text-xs md:text-base font-cairo rounded-lg md:rounded-main transition-all whitespace-nowrap h-9 sm:h-10 md:h-[50px] relative overflow-hidden shrink-0 order-3 w-full sm:w-auto"
                        style={{
