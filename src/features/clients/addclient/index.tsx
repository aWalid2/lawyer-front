...
//   // Profile object
//   formData.append("profile[client_type]", values.client_type);
//   formData.append("profile[notes]", values.notes);
  
//   if (values.has_contract) {
//     if (values.contract_start_date) {
//       formData.append("profile[contract][start_date]", values.contract_start_date);
//     }
//     if (values.contract_value) {
//       formData.append("profile[contract][contract_value]", values.contract_value);
//     }
//     if (values.contract_duration) {
//       formData.append("profile[contract][contract_duration]", values.contract_duration);
//     }
//   }
  
//   // Account inside profile (if add_clients)
//   if (values.add_clients && values.password && values.password.trim() !== "") {
//     formData.append("password", values.password);
//     if (values.confirmation_password) {
//       formData.append("profile[account][confirmation_password]", values.confirmation_password);
//     }
//   }
