  ...
  return (
    <>
      ...
      <div className={CLASSES.flexRow + " mb-4"}>
        ...
        <div className="flex-1">
          <label className={CLASSES.labelText}>المخفر التابع له القضية</label>
          <Select
            value={values.policeStation}
            onValueChange={(value) => setFieldValue("policeStation", value)}
            dir="rtl"
          >
            <SelectTrigger className={CLASSES.selectTrigger}>
            ...
            <SelectContent
              className={`${CLASSES.selectContent} lg:w-[447px] sm:w-[250px] md:w-[300px] w-full`}
            >
              <SelectItem value="police1">مخفر الأزاريطة</SelectItem>
              <SelectItem value="police2">مخفر سيدي جابر</SelectItem>
              <SelectItem value="police3">مخفر محرم بك</SelectItem>
              <SelectItem value="police4">مخفر كرموز</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>

      {/* رقم القضية في المخفر + تاريخ ورود القضية في المخفر */}
      <div className={CLASSES.flexRow + " mb-4"}>
        <div className="flex-1">
        ...
        <div className="flex-1">
          <label className={CLASSES.labelText}>تاريخ ورود القضية في المخفر</label>
          <Field
            name="dateInPoliceStation"
            type="date"
      ...
      {/* تاريخ تسجيل القضية في الادعاء العام + تاريخ ورود القضية في المكتب */}
      <div className={CLASSES.flexRow + " mb-4"}>
        <div className="flex-1">
          <label className={CLASSES.labelText}>تاريخ تسجيل القضية في الادعاء العام</label>
          <Field
