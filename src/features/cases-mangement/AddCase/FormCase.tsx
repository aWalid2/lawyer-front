...
const CLASSES = {
    ...
    uploadContainer: "border border-gray-300 border-dashed border-2 rounded-xl bg-[#FBFBFB] flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-100 transition",
    ...
    fieldWithIcon: "w-full border rounded-md p-2 bg-[#FBFBFB] h-10 md:h-[50px] pr-10",
                ...
                <div className="p-6 shadow-gray-400 shadow-2xl">
                    ...
                    <div className={CLASSES.formSection}>
                        <Form>
                            {/* وضع القضية */}
                            <div className="mb-4">
                                <label className={CLASSES.labelText}>وضع القضية عند الاستلام</label>
                                <Select
                            ...
                            <div className={CLASSES.flexRow + " mb-4"}>
                                ...
                                <div className="flex-1">
                                    ...
                                    >
                                        ...
                                        <SelectContent className={`${CLASSES.selectContent} lg:w-[447px] sm:w-[250px] md:w-[300px] w-full`}>
                            ...
                            <div className={CLASSES.flexRow + " mb-4"}>
                                ...
                                <div className="flex-1">
                                    <label className={CLASSES.labelText}>تاريخ ورود القضية داخل المكتب</label>
                                    <Field
                                ...
                                <div className="pt-6">
                                    <div className={CLASSES.formSection}>
                                        ...
                                        <div className={CLASSES.flexRow + " mb-4"}>
                                            ...
                                            <div className="flex-1">
                                                <label className={CLASSES.labelText}>الصفة القانونية</label>
                                                <Field
                                                    name="legalStatus"
                                                    type="text"
                                                    className={CLASSES.inputField}
                                        ...
                                        <div className={CLASSES.flexRow}>
                                            <div className="flex-1">
                                                <label className={CLASSES.labelText}>الرقم القومي </label>
                                                <Field
                                                    name="civilId"
                                                    type="text"
                                                    className={CLASSES.inputField}
                            ...
                            <div className="pt-7">
                                <label className="px-5 max-sm:text-sm flex shrink-0">هل الاتعاب رقم أم نسبة من الأرباح أم تابعة للعقد ؟</label>
