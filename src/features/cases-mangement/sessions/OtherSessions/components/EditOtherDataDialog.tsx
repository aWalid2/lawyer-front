...
export const EditOtherDataDialog: React.FC<EditOtherDataDialogProps> = ({
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className="sm:max-w-[772px] max-h-[90vh] overflow-y-auto sm:px-20 px-6 sm:py-10 py-6 sm:rounded-[24px] rounded-main border-none custom-scrollbar"
        dir="rtl"
          ...
          {() => (
            <Form className="space-y-4">
              ...
              <div className="flex flex-col w-full">
                ...
                <textarea
                  name="notes"
                  className="w-full border border-[#E8E8E8] rounded-main p-4 bg-[#FBFBFB] min-h-[50px] text-secondary text-sm text-right pr-6 disabled:opacity-70"
                />
              </div>
              <DialogClose asChild>
                <button
