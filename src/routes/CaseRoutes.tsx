...
const CaseMangement = lazy(
  () => import("../pages/dashboard/cases/CaseMangement"),
);
...
const RelatedCases = lazy(
  () => import("../pages/dashboard/caseinfo/RelatedCases"),
);
const CaseDocuments = lazy(
  () => import("../pages/dashboard/caseinfo/Documents"),
);
const Expenses = lazy(() => import("../pages/dashboard/caseinfo/Expenses"));
const Payments = lazy(() => import("../pages/dashboard/caseinfo/Payments"));
...
const CaseDocumentDetails = lazy(
  () => import("../pages/dashboard/caseinfo/DocumentDetails"),
);
